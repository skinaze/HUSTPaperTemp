\documentclass[supercite]{HustGraduTrans}
%进行个人信息设置
\origin{Lamport, Leslie. LATEX: a document preparation system: user's guide and reference manual. Addison-wesley, 1994.} %论文出处
\title{论文翻译题目} %论文翻译题目
\author{翻译者姓名} %翻译者姓名
\date{\number\year 年 \number\month 月} %日期，默认当月
\school{院系名称} %院系名称
\classnum{专业班级} %专业班级
